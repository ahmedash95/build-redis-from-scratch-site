...
<Alert message="لو فيه مصطلحات مش فاهمها دلوقتي متشغلش بالك بيها و هتفهما بعدين واحنا بنتكلم علي كل جزء" type="info"></Alert>
...
<Alert message="حتي لو متعرفش Go و Redis. تقدر بردو تقرا المقالات و اكيد هتلاقي حاجات مفيده" type="warning"></Alert>
